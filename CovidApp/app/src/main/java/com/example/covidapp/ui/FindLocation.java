...
import com.example.covidapp.BuildConfig;
...
public class FindLocation extends FragmentActivity implements OnMapReadyCallback {
    ...
    //until here
        ...
        if (savedInstanceState !=null){
            ...
            currentCamera = savedInstanceState.getParcelable(KEY_CAMERA_POSITION);
    ...
    public static FindCurrentPlaceRequest.Builder builder (List<Place.Field.NAME>placeFields){
